...
The second notebook `EX2_Universal_Program` Inputs some integers, then it decodes these integers based on the books decoding, then it gets a list of inputs (`x_1 `)
